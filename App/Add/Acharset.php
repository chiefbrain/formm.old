...
class Acharset
{
    ...
    private function _charset_count_bad($s)
    ...
    private function _charset_count_chars($s)
    ...
    private function _charset_count_pairs($s)
    ...
    private function _charset_alt_win($s)
    {
        for ($i = 0; $i < strlen($s); $i++)
        {
            $c     = ord($s[$i]);
    ...
    private function _charset_koi_win($s)
    {
        $kw = array(
    ...
    private function _charset_utf8_win($s)
    {
        $r     = '';
        $state = 1;
        for ($i = 0; $i < strlen($s); $i++)
    ...
    private function _charset_prepare($s)
    {
        $r = 0;
        $k = 0;
...
// returns a string converted from a best encoding (windows-1251 or koi-8r) to windows-1251
    ...
    /*
      function charset_x_utf($s)
      {
      return iconv("windows-1251", "UTF-8", charset_x_win($s));
      }
     */
...
// returns a string converted from a best encoding (windows-1251 or koi-8r) to windows-1251
        ...
        {
            case 'alt':
                return iconv("windows-1251", "UTF-8", $this->_charset_alt_win($s));
            case 'koi-8r':
                return iconv("windows-1251", "UTF-8", $this->_charset_koi_win($s));
            case 'utf':
                return $s;
            default:
