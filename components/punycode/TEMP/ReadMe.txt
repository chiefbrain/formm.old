...
Examples
--------
1. Say we wish to encode the domain name norgler.com:
...
echo utf8_decode($output); // This will read: andre@borse.knorz.info
...
$input = 'http://norgler:secret@norgler.com/my_path_is_not_ASCII/');
// Encode it to its punycode presentation
$output = $IDN->encode_uri($input);
// Output, what we got now
echo $output; // http://norgler:secret@xn--nrgler-wxa.com/my_path_is_not_ASCII/
